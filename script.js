...
let searchByID=document.getElementById("imdb").value;

if(searchByID!="")
{
    getMovieDetails(searchByID);
}
...
let getMovieDetails = (searchByTitle,searchByYear,searchByID) => {  
    ...
    $.ajax({
        ...
        dataType: 'json', 
        async:true,
        url:'https://www.omdbapi.com/?t='+searchByTitle+'&y='+searchByYear+'&i='+searchByID+'&apikey=df789615 ', // URL of getting data
        success: (data) => { 
